...
| `browser-agent` | Use Vercel's `agent-browser` (`@anthropic-ai/agent-browser`) to navigate the UI, click through flows, and take screenshots of specific states. Best for verifying single UI states or short interactions. |
